...
<style>
  ...
  .rule-item { margin-bottom: 16px; font-size: 14px; line-height: 1.5; color: #555555; clear: both; overflow: hidden; }
  .rule-icon { float: left; font-size: 18px; margin-right: 12px; width: 24px; text-align: center; }
  .rule-text { float: left; width: 85%; }
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="rules-section">
        ...
        <div class="rule-item">
          <div class="rule-icon">🚿</div>
          <div class="rule-text"><strong>Alberca:</strong> Es obligatorio enjuagarse antes de entrar a la alberca utilizando las regaderas de los baños.</div>
        </div>
