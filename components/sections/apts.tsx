...
export function Apts() {
  ...
  const c = {
    ...
    tierra: {
      ...
      imgMain: 'https://image.qwenlm.ai/public_source/592c4b77-5a7f-4d4f-a31e-8c3c89d757fe/12ad38f46-3c16-40cd-8411-17541666c909.png',
      cards: [
    ...
    agua: {
      ...
      imgMain: 'https://image.qwenlm.ai/public_source/592c4b77-5a7f-4d4f-a31e-8c3c89d757fe/10d31ed46-f927-487a-af99-df6cc0f56617.png',
      cards: [
    ...
    aire: {
      ...
      imgMain: 'https://image.qwenlm.ai/public_source/592c4b77-5a7f-4d4f-a31e-8c3c89d757fe/1fc047d69-f766-483e-a506-ca8d9c019516.png',
      cards: [
  ...
  const DesktopPanel = ({ apt, onOpen }: { apt: typeof c.tierra; onOpen: () => void }) => (
    <article className="flex-[0_0_84vw] grid grid-cols-[0.85fr_1.15fr] gap-[4vw] items-center">
      ...
      <figure className="aspect-[16/10] shadow-[0_30px_80px_rgba(61,36,56,0.18)] rounded-[calc(var(--radius-arch-img)*1.2)_calc(var(--radius-arch-img)*1.2)_26px_26px] relative overflow-hidden">
        <Image src={apt.imgMain} alt={`Departamento ${apt.name}`} fill className="object-cover" />
      </figure>
    </article>
  );
