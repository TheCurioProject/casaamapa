            ...
            <div className="mt-[2vh] pt-[4vh] border-t border-[rgba(255,255,255,0.2)]">
              <div className="grid grid-cols-2 gap-x-[4vw] gap-y-[4vh]">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <span className="font-display text-[1.4rem] md:text-[1.25rem] leading-[1.1]">Alberca</span>
                </div>
                <div className="flex flex-col gap-3">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-80">
                    <path d="M5 13a10 10 0 0 1 14 0"/><path d="M8.5 16.5a5 5 0 0 1 7 0"/><path d="M2 8.82a15 15 0 0 1 20 0"/><circle cx="12" cy="20" r="1"/>
                  </svg>
                  <span className="font-display text-[1.4rem] md:text-[1.25rem] leading-[1.1]">Wi-Fi de<br/>alta velocidad</span>
                </div>
                <div className="flex flex-col gap-3">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-80">
                    <path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7"/>
                  </svg>
                  <span className="font-display text-[1.4rem] md:text-[1.25rem] leading-[1.1]">Cocina<br/>equipada</span>
                </div>
                <div className="flex flex-col gap-3">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-80">
                  ...
                  <span className="font-display text-[1.4rem] md:text-[1.25rem] leading-[1.1]">Aire<br/>acondicionado</span>
                </div>
                <div className="flex flex-col gap-3">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-80">
                    <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/>
                  </svg>
                  <span className="font-display text-[clamp(1.4rem,4vw,1.25rem)] md:text-[clamp(1.1rem,4vw,1.25rem)] leading-[1.1] break-words">Estacionamiento<br/>privado</span>
                </div>
              </div>
            </div>
          </div>
