      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <nav className="flex flex-col gap-[0.6vh]">
              {[
                ...
                <motion.a 
                  ...
                  className="flex items-baseline gap-[0.8em] py-[0.4em] px-[0.1em] font-medium text-lg text-[var(--color-cream)] hover:text-[var(--color-ink)] border-b border-[rgba(249,241,239,0.1)] transition-colors"
                >
            ...
            >
              <a href="mailto:admin.casaamapa@gmail.com" className="hover:text-[var(--color-ink)] transition-colors break-all">admin.casaamapa@gmail.com</a>
              
              <div className="flex items-center gap-5 mt-1">
                {/* Facebook */}
                <a href="#" className="hover:text-[var(--color-ink)] transition-colors" aria-label="Facebook">
                ...
                {/* Instagram */}
                <a href="#" className="hover:text-[var(--color-ink)] transition-colors" aria-label="Instagram">
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/523113944729" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-ink)] transition-colors" aria-label="WhatsApp">
