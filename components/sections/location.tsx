    ...
    >
      <div className="max-w-[1200px] mx-auto px-[var(--spacing-pad-x)] flex flex-col md:flex-row gap-[8vw] items-center">
        ...
        <div className="flex-1 w-full js-fade-loc">
          <div className="aspect-[4/3] w-full rounded-[calc(var(--radius-arch-img)*0.8)_calc(var(--radius-arch-img)*0.8)_20px_20px] overflow-hidden shadow-[0_30px_60px_rgba(30,40,25,0.2)]">
            <iframe 
